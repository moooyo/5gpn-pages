...
import { collapse, subtract, union, normalizeDomain } from './domains.mjs';
...
function relayPayload({ relayHost, token, match, excluded, http3, uiToggle }) {
  ...
  const p = {
    ...
    Relays: [relay],
    // iOS 26+: when false the user cannot toggle the relay off (needs MDM lockdown to persist).
